...
public class FragmentDoc extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mStorage = FirebaseStorage.getInstance().getReference().child("postDoc");
        view = inflater.inflate(R.layout.fragment_doc, container, false);
        gridDocView = view.findViewById(R.id.grid_docview);
        add_btn = view.findViewById(R.id.add_btn);
        add_btn.setOnClickListener(this);
        databaseReference = FirebaseDatabase.getInstance().getReference("PostDoc").child(fuser);
...
//        loadData(view);
    ...
    private void setdata(ArrayList<RestModel> dataModelArrayList) {
        ...
        MyDocBaseAdapter myDocBaseAdapter  = new MyDocBaseAdapter(getContext(),dataModelArrayList);
        gridDocView.setAdapter(myDocBaseAdapter);
    }
    ...
    public void onClick(View view) {
        ...
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE ) == PackageManager.PERMISSION_GRANTED) {
            ...
            startActivityForResult(Intent.createChooser(intent,"Select DOCX"), SELECT_FILE);
        } else {
...
//            imageHoldUri = result.getUri();
            ...
            final StorageReference filePath1 = mStorage.child(System.currentTimeMillis() + ".doc" );
